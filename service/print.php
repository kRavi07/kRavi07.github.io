...
$pdf->SetFont('Arial','B',14);
$pdf->Cell(30,6,'Service',0,0,'L',true);
$pdf->Cell(30,6,'',0,0,'L',);


$pdf->SetFont('Helvetica','',12);
$pdf->Cell(40,6,$_SESSION['service'],0,1,'L',true);
$pdf->Ln();
...
$pdf->Cell(40,6,$_SESSION['user_mail'].$_SESSION['user_mobile'],0,0,'L',true);
$pdf->Cell(40,6,'',0,0,'L',);
...
$pdf->SetTextColor(255,255,255);
$pdf->SetFillColor(245, 103, 11 );
$pdf->Cell(55,7,'Service Man',0,0,'L',true);
...
$pdf->SetTextColor(255,255,255);
$pdf->SetFillColor(245, 103, 11 );
$pdf->Cell(30,7,'SERVICE',0,0,'L',true);
...
$pdf->Cell(55,7,$_SESSION['worker_name'],0,0,'L',true);

$pdf->Cell(32,5,'',0,0,'L');


$pdf->Cell(30,7,$_SESSION['TXNAMOUNT'],0,0,'L',true);

$pdf->Cell(8,5,'',0,0,'L');


$pdf->Cell(30,7,$_SESSION['service'] ,0,0,'L',true);
...
$pdf->Cell(30,6,'Rs  ',0,1,'L');
$pdf->Ln();
$pdf->Cell(130,5,'',0,0,'L');
$pdf->Cell(30,6,'Taxes',0,0,'L');
$pdf->Cell(30,6,$_SESSION['gst'],0,1,'L');
$pdf->Ln();
$pdf->Cell(130,5,'',0,0,'L');
$pdf->Cell(30,6,'Discount',0,0,'L');
$pdf->Cell(30,6, 'Rs ' ,0,0,'L');
...
$pdf->Cell(100,6,'Service is Non-Refundable & Non-Returnable ',0,1,'L',true);
