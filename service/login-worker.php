...
<div class="container">
	...
	<form action="worker-register.php" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
  <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text"><i class="bi-person-check" style="font-size: 1.5rem;color:cornflowerblue";></i></span>
    </div>
  ...
  <div class="input-group mb-3">
  	<div class="input-group-prepend">
      <span class="input-group-text"><i class="bi-phone" style="font-size: 1.5rem;color:cornflowerblue";></i></span>
    </div>
  ...
  <div class="input-group mb-3">
  	<div class="input-group-prepend">
      <span class="input-group-text" style="font-size: 1.5rem;color:cornflowerblue;"><i class="bi-envelope-open"></i></span>
    </div>
...
<div class="input-group mb-3">
   ...
   <input type="text" class="form-control" id="uname" placeholder="Expected Service Charge" name="charge" required>
  ...
  <label for="file" class="mb-3">Upload your image</label>
  <div class="input-group mb-3">
  	<div class="input-group-prepend">
      <span class="input-group-text" style="font-size: 1.5rem;color:cornflowerblue;"><i class="bi-file-earmark-image"></i></span>
    </div>
    <input type="file" class="form-control" id="email" placeholder="Upload File" name="image_file" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
  ...
  <div class="input-group mb-3">
  	<div class="input-group-prepend">
      <span class="input-group-text" style="font-size: 1.5rem;color:cornflowerblue;"><i class="bi-file-earmark-person"></i></span>
    </div>
    
    <input type="file" class="form-control" id="email" placeholder="Upload File" name="id_file" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
  ...
  <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text" style="font-size: 1.5rem;color:cornflowerblue;"><i class="bi-info"></i></span>
    </div>
  ...
  <div class="input-group mb-3">
  	<div class="input-group-prepend">
      <span class="input-group-text"><i class="bi-key" style="font-size:1.5rem;color:cornflowerblue;"></i></span>
    </div>
...
<div id="message"></div>
  ...
  <input type="submit" class="btn btn-outline-success" value="Register" name="signup">
</form>
       </div>
		...
		<form action="worker-validation.php" method="POST" class="needs-validation" novalidate>
  <div class="input-group mb-3">
     <div class="input-group-prepend">
      <span class="input-group-text"><i class="bi-person-check" style="font-size: 1.5rem;color:cornflowerblue";></i></span>
    </div>
