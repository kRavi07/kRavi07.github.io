                ...
                <div class="card-body">
                    <form action="add_blog.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="input__label">Blog title</label>
                            <input type="text" class="form-control input-style" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="blog_title" placeholder="Enter Blog title">
                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Blog Iamge</label>
                            <input type="file" class="form-control input-style" id="exampleInputPassword1"
                                placeholder="Blog Image" name="bimage">
                        </div>
                        <div class="form-group">
                            <label for="txtarea" class="input__label">Main Content</label>
                            <textarea class="form-control input-style" id="txtarea" name="main_content">
                        ...
                        <input type="submit" class="btn btn-primary btn-style mt-4" name="submit">
                    </form>
                </div>
            </div>
            <!-- //forms 1 -->
