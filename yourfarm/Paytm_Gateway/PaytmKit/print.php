...
$pdf->SetFont('Helvetica','',12);
$pdf->Cell(40,6,'Weekly',0,1,'L',true);
$pdf->Ln();
...
$pdf->SetFont('Arial','B',14);
$pdf->Cell(30,6,'Transactio Id',0,0,'L',true);
$pdf->Cell(30,6,'',0,0,'L',);


$pdf->SetFont('Helvetica','',12);
$pdf->Cell(40,6,$_SESSION['TXNID'],0,1,'L',true);
$pdf->Ln();
...
$pdf->Cell(30,6,$_SESSION['price']*$_SESSION['qty'],0,1,'L');
$pdf->Ln();
$pdf->Cell(120,5,'',0,0,'L');
...
$pdf->Cell(30,6, $_SESSION['discount'] ,0,0,'L');
...
$pdf->Cell(15,6,$_SESSION['TXNAMOUNT'],0,1,'L',true);
