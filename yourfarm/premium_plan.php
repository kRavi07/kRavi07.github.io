   	...
   	<div class="row custom_box">
        ...
        <div class="row" >
        	...
        	<div class="col-md-5 ui-widget-content    plan b1 btn" id="box" onmouseover="hover();" onmouseout="unhover();" onclick="deta(this);"  >  <img src="image/orange.png" class="img-fluid py-1 px-2" id="img_hov" >     
                 <h5 class="text-center "id="title">Premium Box 1</h5>

                 <input type="text" name="price" value="300" id="price_box" disabled="">                     
        	 </div>
        	<div class="col-md-5  ui-widget-content plan  text-center btn"  id="box1" onmouseover="hover1();" onmouseout="unhover1();" onclick="deta1();"  ><img src="image/veg1.png" class="img-fluid py-1 px-2" id="img_hov1"> 
                <h5 class="text-center title">Premium Box 2</h5>
                <input type="text" name="price" value="600" id="price_box1" disabled="">
        	...
        	<div class="col-md-5 ui-widget-content plan text-center btn" id="box2" onmouseover="hover2();" onmouseout="unhover2();" onclick="deta2();"><img src="image/veg2.png" class="img-fluid py-1 px-2" id="img_hov2">
                  <h5 class="text-center title">Premium Box 3</h5>
                  <input type="text" name="price" value="140" id="price_box2" disabled="">               
        	 </div>
        	<div class="col-md-5  ui-widget-content plan text-center btn " id="box3" onmouseover="hover3();" onmouseout="unhover3();" onclick="deta3();"><img src="image/veg3clr.png" class="img-fluid py-1 px-2" id="img_hov3"> 
                  <h5 class="text-center title">Premium Box 4</h5>
                  <input type="text" name="price" value="350" id="price_box3" disabled="">
        	</div>
        </ol>
        </div>
...
<div class="container">
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        <ul>
        <li><strong>Premuim Box 1</strong> 
          <span>  This box  contain Broccoli,Colored Capsicum, Red cabbage, Cherry Tomato.   </span>
        </li>

        <li><strong>Premium Box 2</strong>
          <span>  This box  contain Red  Cabbage ,Parsley ,Celery  , Cherry Tomato.       </span>
        </li>

        <li><strong>Premium Box 3</strong>
          <span>  This box  contain Asparagus,Broccoli,Chinese Cabbage ,Zucchini     </span>
        </li>

        <li><strong>Premium Box 4</strong>
          <span>  This box  contain Asparagus, Broccoli,Colored Capsicum, Red cabbage, Cherry Tomato.     </span>
        </li>
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
         <ul>
              <li><strong>Premium Box 1</strong> 
          <span>  This box contain 200g of each product.     </span>
        </li>

        <li><strong>Premium Box 2</strong>
          <span>   This box contain 400g of each product.    </span>
        </li>

        <li><strong>Premium Box 3</strong>
          <span>   This box contain 600g of each product.    </span>
        </li>
